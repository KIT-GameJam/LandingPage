<template>
  <header class="z-10">
    <nav>
      <div
        class="flex w-full items-center justify-between gap-x-12 bg-gradient-to-br from-red-200 to-violet-200 p-6"
      >
      ...
      <div class="h-1 bg-gradient-to-r from-red-300 to-violet-300" />
    </nav>
  </header>
</template>

    ...
    <div>
      <nav class="flex w-full items-center justify-between gap-x-12 p-6">
        <div class="flex gap-x-12">
          <a
            class="group flex items-center justify-center gap-x-4 text-2xl font-bold"
            href="/"
          >
            <img
              class="hidden transition-transform group-hover:-rotate-12 sm:inline-block"
              height="64"
              width="64"
        ...
        <div class="flex items-center gap-x-6">
          ...
          >
            <a
              class="dark:hover:text-prime-300 hover:text-prime-700 text-second-700 dark:text-second-300 hidden rounded-md px-2 py-1 lg:inline"
              href="/#schedule"
              >{{ $t('nav.schedule') }}</a
            >
            <a
